...
# Sentiment analysis with individual text sentiments
def sentiment_analysis(text_series):
    ...
    # Combine original text with detected sentiment
    ...
    return sentiment_counts, sentiment_analysis_df
...
if uploaded_file:
    ...
    if selected_column:
        ...
        sentiment_counts, sentiment_analysis_df = sentiment_analysis(text_data)
        
        # Display sentiment counts chart
        st.bar_chart(sentiment_counts)
        st.write("Sentiment Counts:")
        st.table(sentiment_counts)
        
        # Display table with each text and its detected sentiment
        st.write("Text vs. Detected Sentiment:")
        st.dataframe(sentiment_analysis_df)
